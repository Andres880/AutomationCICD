...
public class ProductCatalogue extends AbstractComponent{
	...
	{
		WebElement producto = getProductList().stream().
	...
	{
		WebElement producto = getProductByName(productName);
		producto.findElement(addToCart).click();
		waitForElementToAppear(toastMessage);
		waitForElementToDesappear(animating);
	}
